...
from vl_saliency._core.dispatcher import assign_auto, get_qk_accumulator
...
class SaliencyAccumulator:
    ...
    Args:
        ...
        **kwargs: Additional keyword arguments from the forward pass, passed to the patch layout funtion.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layout = SequenceLayout(config, input_ids=input_ids, **kwargs)
    ...
    def accumulate_qk(self, q: Float[Tensor, "B Hq T D"], k: Float[Tensor, "B Hkv T D"]):
        ...
        self._saliency = self._qk_update(
            q,
            k,
    ...
    def _resolve_qk_fn(self, config: SaliencyConfig):
        ...
        self._qk_update = get_qk_accumulator(
            backend=backend,
